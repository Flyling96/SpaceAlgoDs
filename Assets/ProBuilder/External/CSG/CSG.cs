...
namespace UnityEngine.ProBuilder.Csg
{
    ...
    static class Boolean
    {
        ...
        public static Model Union(Model model,GameObject add)
        {
            Model csg_model_b = new Model(add);
        ...
        public static Model Intersect(GameObject lhs, GameObject rhs)
        {
            ...
            Node r = Node.Intersect(a, b);
            if(r.polygons == null)
            {
                return null;
            }
            List<Polygon> polygons = r.AllPolygons();

            return new Model(polygons);
        }

        public static Model IntersectOne(GameObject lhs, GameObject rhs)
        {
            Model csg_model_a = new Model(lhs);
            Model csg_model_b = new Model(rhs);
