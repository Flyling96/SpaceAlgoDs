...
namespace UnityEditor.ProBuilder
{
    static class EditorToolbarMenuItem
    {
		...
		[MenuItem(k_MenuPrefix + "Object/Pro BuilderizeUnion", true, PreferenceKeys.menuGeometry + 2)]
		static bool MenuVerify_ProBuilderizeUnion()
		{
			var instance = EditorToolbarLoader.GetInstance<ProBuilderizeUnion>();
			return instance != null && instance.enabled;
		}

		[MenuItem(k_MenuPrefix + "Object/Pro BuilderizeUnion", false, PreferenceKeys.menuGeometry + 2)]
		static void MenuPerform_ProBuilderizeUnion()
		{
			var instance = EditorToolbarLoader.GetInstance<ProBuilderizeUnion>();
			if (instance != null && instance.enabled)
			{
